...
# ╔═╡ e0812d36-ba32-11ec-3c9e-093abdb8872d
begin
	using Altro
	using RobotZoo
	using StaticArrays
...
# ╔═╡ 3ea30b8c-2f48-4d2e-9cf4-2aa9c7a899ac
...
# ╔═╡ 4e11ccee-59ed-4000-9ac0-438f60cd420a
body = quote
  da = u[1]
  ϕ = u[2]
...
[[Altro]]
deps = ["BenchmarkTools", "Crayons", "FiniteDiff", "Formatting", "ForwardDiff", "Interpolations", "LinearAlgebra", "Logging", "Octavian", "QDLDL_jll", "RobotDynamics", "RobotZoo", "Rotations", "SolverLogging", "SparseArrays", "StaticArrays", "Statistics", "TimerOutputs", "TrajectoryOptimization"]
git-tree-sha1 = "e6f0060e3d15ba797a303a9f63705e3871238a13"
...
git-tree-sha1 = "26c004c96dc634cefe9174cb9180c496f6c7e100"
...
[[QDLDL_jll]]
deps = ["Artifacts", "JLLWrappers", "Libdl", "Pkg"]
git-tree-sha1 = "54cb0359f294f8b3cbf4ba30208e41d7b8bd116b"
uuid = "9ae34a36-e1b6-54e9-a33d-8bba9913f854"
version = "0.1.5+0"
...
[[RobotDynamics]]
deps = ["FiniteDiff", "ForwardDiff", "LinearAlgebra", "RecipesBase", "Rotations", "SparseArrays", "StaticArrays"]
git-tree-sha1 = "fbaae05add58f75a3ba23c356dae8e2d5dd1c417"
uuid = "38ceca67-d8d3-44e8-9852-78a5596522e1"
version = "0.4.6"

[[RobotZoo]]
deps = ["FiniteDiff", "ForwardDiff", "LinearAlgebra", "RobotDynamics", "Rotations", "StaticArrays"]
git-tree-sha1 = "e0b5ddc4451c38ab470ac3e5089939824beb89fb"
...
[[SolverLogging]]
deps = ["Crayons", "Formatting", "Logging", "Printf"]
git-tree-sha1 = "ebe090fc0a0f83685b5bfd7d1eb3fd870bbd1773"
uuid = "c2e08473-88be-4f39-9d3c-afcdb6e3aeb8"
version = "0.2.0"
...
deps = ["DocStringExtensions", "FiniteDiff", "ForwardDiff", "LinearAlgebra", "RobotDynamics", "RobotZoo", "Rotations", "SparseArrays", "StaticArrays"]
git-tree-sha1 = "1e449355d1a81f2bb54f7f5aba8ac33b69599130"
